  ...
  return (
    <div className='footer d-flex flex-column  justify-content-center' style={{width: '100%', height:'300px', lineHeight: '35px'}}>
       <div className='d-flex justify-content-evenly flex-wrap'>
         ...
         <h6 className='mt-2'>Designed and built with all the love in the world by the  Eat'n team with the help of our contributors.</h6>
         <h6>Code licensed  Eat'n team, docs CC BY 3.0.</h6>
         ...
         <div className="contact">
          ...
          <div className='d-flex'>
            ...
            <button className='btn btn-warning ms-2 rounded' style={{width:'120px'}}>Subscribe</button>
          </div>
